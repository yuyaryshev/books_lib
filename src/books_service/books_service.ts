...
import { makeCallerUrl } from "../api/index.js";
...
export function initBooksLibService(opts0: BookLibServerSettings) {
  ...
  async function start() {
    ...
    const book_bodies_knex = bodies_in_same_db ? knex : Object.assign(knexLib({
      ...opts.book_bodies_db,
      useNullAsDefault: true
    }), {
      id: "bodies_db",
