...
// DOMAIN(Book)
import { BaseTable, BaseRowDefaultFields, RowWithIdT, TableDescriptor, declareBaseColumns } from "./db_generics/BaseTable.js";
...
export interface BookBodyRowT extends RowWithIdT {
    // DOMAIN_FIELDS(BookBody).Ancestors DOMAIN_FIELDS(BookBody)
    body: string;
}
